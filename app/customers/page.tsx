        ...
        {loading ? (
          ...
          customers.map(customer => (
            <Link 
              ...
              key={customer.id}
              className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-blue-500 hover:shadow-lg transition-all group flex flex-col justify-between min-h-[200px]"
            >
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white line-clamp-1">{customer.full_name}</h3>
                <p className="text-slate-500 text-sm mt-1">{customer.whatsapp_number || "No WhatsApp"}</p>
              </div>
              
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800">
                <p className="text-sm font-medium text-slate-500 mb-1">Total Khata Balance</p>
